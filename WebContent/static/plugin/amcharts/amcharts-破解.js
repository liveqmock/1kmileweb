...
AmCharts.ValueAxis = AmCharts.Class({
	...
	draw: function() {
		...
		if (this.logarithmic && (0 >= this.getMin(0, this.data.length - 1) || 0 >= this.minimum)) this.fire("logarithmicAxisFailed", {
			...
			if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) g = !0;
				...
				w = !1;
				for (d = n; d < s; d += p) y = AmCharts.roundTo(this.step * d + this.min, r), -1 != String(y).indexOf("e") && (w = !0, String(y).split("e"));
				...
				for (d = n; d < s; d += p) if (n = r * d + this.min, n = AmCharts.roundTo(n, this.maxDecCount + 1), !this.integersOnly || Math.round(n) == n) if (isNaN(u) || Number(AmCharts.toFixed(n, u)) == n) {
					...
					if (!isNaN(G) && 0 < y && d < s - 1) {
						...
						for (c = 1; c < r / G; c++) E = this.getCoordinate(n + G * c), E = new this.axisItemRenderer(this, E, "", !1, 0, 0, !1, !1, 0, !0), this.pushAxisItem(E);
						this.gridAlpha = t
					}
				}
				d = this.baseValue;
	...
	stackGraphs: function(a) {
		...
		var c = [],
			...
			k, l, m, p, n = this.baseValue,
			s = !1;
		if ("line" == a || "step" == a || "smoothedLine" == a) s = !0;
		if (s && ("regular" == b || "100%" == b)) for (p = 0; p < h.length; p++) m = h[p], m.hidden || (l = m.type, m.chart == this.chart && m.valueAxis == this && a == l && m.stackable && (k && (m.stackGraph = k), k = m));
...
AmCharts.RecItem = AmCharts.Class({
	construct: function(a, b, c, d, e, f, g, h, k, l) {
		...
		ra && ra.translate(V, pa);
		!1 === a.visible && (ra && ra.remove(), x && (x.remove(), x = null));
		x && (x.attr({
			"text-anchor": P
...
AmCharts.AmGraph = AmCharts.Class({
	...
	createSerialGraph: function() {
		...
		var l = this.width,
			...
			u = [],
			v = [],
			t, w, y, E, z = this.chart.graphs.length,
			A, I = this.dx / this.depthCount,
			...
			if (ua) {
				...
				case "line":
					if (isNaN(Z)) r || (this.drawLineGraph(u, v, Q, R), u = [], v = [], Q = [], R = []);
						...
						ja = D;
						ka = C;
						!Ea || isNaN(L) || isNaN(N) || (Q.push(N), R.push(L));
				...
				case "column":
					...
					if (!isNaN(Z)) {
						...
						if (qa && (ta = qa.set, ta.translate(S, T), this.columnsSet.push(ta), (x.url || this.showHandOnHover) && ta.setAttr("cursor", "pointer"), !W)) {
							...
							if ("regular" == B || "100%" == B)"inside" != K && (K = "middle"), A = n ? 0 < ua.value ? (this.end + 1 - J) * z + c : (this.end + 1 - J) * z - c : 0 < ua.value ? z * J + c : z * J - c;
					...
					if (!isNaN(na) && !isNaN(Z)) {
						...
						if (n) {
							if (T = C - h / 2, S = N, O = h, T + O > m && (O = m - T), 0 > T && (O += T, T = 0), T < m && 0 < O) {
								var nb, ob;
								Z > na ? (nb = [D, Ja], ob = [N, Ia]) : (nb = [N, Ja], ob = [D, Ia]);
								!isNaN(Ja) && !isNaN(Ia) && C < m && 0 < C && (db = AmCharts.line(e, nb, [C, C], oa, $, X), mb = AmCharts.line(e, ob, [C, C], oa, $, X));
								aa = D - N;
							...
							!isNaN(Ba) && !isNaN(Aa) && D < l && 0 < D && (db = AmCharts.line(e, [D, D], pb, oa, $, X), mb = AmCharts.line(e, [D, D], qb, oa, $, X))
						}
				...
				if (!W && !isNaN(Z)) {
					...
					if (this.end - this.start <= Fb || 0 === Fb) {
						...
						if (Gb) {
							...
							if (ea) {
								if (isNaN(fa) || isNaN(ba)) ea.remove(), ea = null;
		...
		if ("line" == g || "step" == g || "smoothedLine" == g)"smoothedLine" == g ? this.drawSmoothedGraph(u, v, Q, R) : this.drawLineGraph(u, v, Q, R), W || this.launchAnimation();
			...
			if (s) {
				...
				if (c.mouseIsOver || A || I || this.forceShow) if (this.forceShow = !1, I) {
					...
					if (this.oneBalloonOnly) {
						k = Infinity;
						for (t = 0; t < G.length; t++) g = G[t], g.showBalloon && !g.hidden && g.balloonText && (w = s.axes[g.valueAxis.id].graphs[g.id], y = w.y, isNaN(y) || (r ? Math.abs(e - y) < k && (k = Math.abs(e - y), K = g) : Math.abs(f - y) < k && (k = Math.abs(f - y), K = g)));
	...
	draw: function() {
		...
		if (!isNaN(a)) {
			...
			if (this.show) {
				...
				m.innerHTML = '<div style="text-align:center; ' + A + "max-width:" + this.maxWidth + "px; font-size:" + y + "px; color:" + this.color + "; font-family:" + w + '">' + this.text + "</div>";
				...
				for (y = 0; y < w.length; y++) {
					...
					for (z = 0; z < a.length; z++) {
						...
						if (b.valueAxis.id == E) {
							...
							var B = t;
							b.dataProvider && (B = c);
							G.values = this.processValues(B, b, I);
							!b.connect && u && v.time - p > 1.1 * n && (u.gap = !0);
...
AmCharts.bullet = function(a, b, c, d, e, f, g, h, k, l, m) {
	...
	case "yError":
		...
		break;
	case "xError":
		p = a.set(), p.push(AmCharts.line(a, [-c / 2, c / 2], [0, 0], d, e, f)), p.push(AmCharts.line(a, [-c / 2, -c / 2], [-k, k], d, e, f)), p.push(AmCharts.line(a, [c / 2, c / 2], [-k, k], d, e, f))
	}
	p && p.pattern(m);
	return p
};
	...
	createEntry: function(a) {
		if (!1 !== a.visibleInLegend) {
			...
			var k = this.container,
				...
				p = 0,
				n = l / 2;
			if (this.useGraphSettings) if (m = a.type, this.switchType = void 0, "line" == m || "step" == m || "smoothedLine" == m || "ohlc" == m) g = k.set(), a.hidden || (d = a.lineColorR, f = a.bulletBorderColorR), p = AmCharts.line(k, [0, 2 * l], [l / 2, l / 2], d, a.lineAlpha, a.lineThickness, a.dashLength), g.push(p), a.bullet && (a.hidden || (d = a.bulletColorR), p = AmCharts.bullet(k, a.bullet, a.bulletSize, d, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (p.translate(l + 1, l / 2), g.push(p)), n = 0, m = l, p = l / 3;
			else {
				var s;
