...
<#macro pager pager baseUrl parameterMap = {} maxShowPageCount = 6>
	...
	<#local lastPageUrl = baseUrl + "pager.pageNumber=" + totalCount + parameter />
	...
	<#if (endPageNumber > totalCount)>
		<#local endPageNumber = totalCount />
	</#if>
...
<#-- 文章内容分页 -->
<#macro articleContentPager article totalCount baseUrl pageNumber isPreview = false maxShowPageCount = 5>
	...
	<#local lastPageUrl = baseUrl + param + totalCount />
	<#if pageNumber == 1>
